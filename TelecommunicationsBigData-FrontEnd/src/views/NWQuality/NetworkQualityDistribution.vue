    ...
    <div>
        <el-form :inline="true" :model="formInline" class="demo-form-inline">
            <el-form-item label="网络质量">
                <el-select
                    v-model="formData.speedType"
                    placeholder=""
                    clearable
                >
                    <el-option label="上传速度" value="ulspeed" />
                    <el-option label="下载速度" value="dlspeed" />
